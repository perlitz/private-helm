...
class BIGBenchScenario(Scenario):
    """
    Details on ethics dataset at berkeley
    """
    ...
    description = (
        "This consists of test_hard data from Aligning AI With Shared Human Values by Dan Hendrycks, Collin Burns, Steven Basart,"
        + "Andrew Critch, Jerry Li, Dawn Song, and Jacob Steinhardt, published at ICLR 2021."
    )
