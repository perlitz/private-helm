entries = [
    ...
    # Truthful QA
    {'scenario':'truthful_qa','description': "truthful_qa:task=mc_single,model=neurips/local,data_augmentation=canonical", 'priority': 1},
...
if __name__ == "__main__":
    ...
    with open(f'./run_specs_open_{args.example_budget}_budget.conf','w') as f:
        f.write('entries: [\n')
        last_scenario = ''
    ...
    print(f'Saved ./run_specs_open_{args.example_budget}_budget.conf')
